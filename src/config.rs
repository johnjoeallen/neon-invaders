...
pub const PLAYER_COOLDOWN: f32 = 0.18;
pub const PLAYER_BOMB_COOLDOWN: f32 = 0.55;
pub const PLAYER_RAPID_FIRE_COOLDOWN: f32 = 0.07;

pub const PLAYER_SHOT_SPEED: f32 = 1140.0;
pub const PLAYER_BOMB_SPEED: f32 = 760.0;
pub const PLAYER_BOMB_RADIUS: f32 = 150.0;
pub const ENEMY_SHOT_SPEED: f32 = 448.0;
...
pub const ALIEN_SPACING_X: f32 = 110.0;
pub const ALIEN_SPACING_Y: f32 = 82.0;
pub const ALIEN_SIZE: Vec2 = Vec2::from_array([58.0, 42.0]);
pub const ALIEN_START_X: f32 = 465.0;
pub const ALIEN_START_Y: f32 = 164.0;
pub const ALIEN_BASE_SPEED: f32 = 94.0;
pub const ALIEN_STEP_DOWN: f32 = 32.0;
pub const ALIEN_STEP_DOWN_PASS_BONUS: f32 = 1.5;
pub const ALIEN_MARCH_DISTANCE: f32 = 66.0;
...
pub const BUNKER_Y: f32 = WINDOW_HEIGHT - 252.0;

pub const PLAYER_ZONE_Y: f32 = WINDOW_HEIGHT - 144.0;
...
pub const BG_GLOW_A: Color = Color::from_rgba(52, 180, 255, 255);
pub const BG_GLOW_B: Color = Color::from_rgba(255, 110, 164, 255);
pub const BG_GLOW_C: Color = Color::from_rgba(255, 205, 104, 255);
pub const FLOOR_GLOW: Color = Color::from_rgba(36, 210, 255, 255);
pub const HUD_COLOR: Color = Color::from_rgba(213, 240, 255, 255);
pub const HUD_PANEL_BG: Color = Color::from_rgba(9, 14, 32, 214);
pub const HUD_PANEL_EDGE: Color = Color::from_rgba(128, 220, 255, 110);
pub const HUD_PANEL_INNER: Color = Color::from_rgba(255, 255, 255, 18);
